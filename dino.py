...
while(1):
    ...
    #img=img[100:300,400:600]
    #print(height,width) 480*6404
    top, right, bottom, left = 100, 250, 425, 490
    ...
    #Central mass of first order moments
        ...
        if(cy > (height/2)+70 and center == True):
            ...
            PressKey(DOWN)
            ReleaseKey(DOWN)
    cv2.line(img,(0,math.floor(height/2)-70),(width,math.floor(height/2)-70),(255,255,255),5)
    cv2.line(img,(0,math.floor(height/2)+70),(width,math.floor(height/2)+70),(255,255,255),5)
